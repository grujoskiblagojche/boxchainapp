            ...
            <View style={[ grid.appWrapper, colors.bg_darkest ]}>
                <View style={ grid.container }>
                    ...
                    <View style={ [grid.flex_column, ui.t_60] }>
                        <Text style={[ typo.subtitle, ui.b_15, colors.c_light ]}>Your profile has been banned for the next 24 hours.</Text>
                        <Text style={[ typo.text, colors.c_medium ]}>- "Suspicious profile usage".</Text>
                    </View>
